...
- Modified `Insert` and `Update` methods in the `GenericRepository` to filter out non-primitive types or `DateTime`.
...
### Simplified Approach
1. **Use ViewModels for Decoupling**: Continue using view models to decouple the web app from the API entities.
